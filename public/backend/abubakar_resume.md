...
**Software Engineering:** Object-Oriented Programming (OOP), Design Patterns, System Design, Performance Optimization, Code Review, Agile/Scrum
**Integrations:** Stripe, SendGrid, Google Analytics, Looker BI
**Tools:** VS Code, PyCharm, Postman, Redis, ESLint, Prettier
